...
def mainMenu(window):
    ...
    labelframe_mainMenu.grid(column = 0,row = 1, padx = 5, pady = 10,sticky="nw")
    ...
    btn_connect = ttk.Button(labelframe_mainMenu, text="Connect")
    btn_connect.grid(column=0, row=3, padx=4, pady=4)

    btn_start = ttk.Button(labelframe_mainMenu, text="Start")
    btn_start.grid(column=1, row=3, padx=4, pady=4)
