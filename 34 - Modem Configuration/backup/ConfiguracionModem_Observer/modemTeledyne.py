...
class ModemTeledyne(AbstractModem):
    ...
    def __init__(self,port,baud) -> None:
        ...
        #This flag if for Controlling the loop
        self.flag = False

        # teledyne = xml.dom.minidom.parse('\\config\\localModemConfig.xml') #TODO: change the path, not make it hard coded
        teledyne = xml.dom.minidom.parse('C:\\Users\\vtilve\\Desktop\\VictorTilve\\GitHub\\My-python-Workbook\\30 - SerialTerminal-and-Parser\\ConfiguracionModem_Observer\\config\\localModemConfig.xml') #TODO: change the path, not make it hard coded
        ...
        #Loading the information from the XML
...
#####
    ...
    def closeCommandLow(self) -> bool:
        '''
        This function close the communication puttin the modem in Online mode
